...
export default function Signup() {
    ...
    return (
        <>
            <div className="header-signup text-center d-flex align-items-center">
                <Container>
                    <Row className="justify-content-md-center">
                        ...
                        <Col sm="6" className="text-md-end">
                            <Link to="/signin">
                                <Button variant="primary-border">Sign In</Button>
                            </Link>
                        </Col>
                    </Row>
                </Container>
            </div>
            <div className="signup-content space-sec">
                <Container>
                    <Row>
                        <Col className="text-center mx-auto">
                            <img className="signup-welcome-img" src={require('./assets/images/signup_welcome.png')} alt="Sign Up Welcome" />
                            <div className="title-wrap">
                                <h2 className="title text-primary mt-3">Welcome to Kaykewalk</h2>
